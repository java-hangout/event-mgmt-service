package com.jh.tds.ems.config;

import com.jh.tds.ems.util.JwtAuthenticationFilter;
import com.jh.tds.ems.util.JwtUtil;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/api/events/**").permitAll() // Allow access to authentication routes
